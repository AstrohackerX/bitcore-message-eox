...
bitcore-message-eox adds support for verifying and signing eox messages in [Node.js](http://nodejs.org/) and web browsers.
...
```sh
npm install bitcore-message-eox
```

```sh
bower install bitcore-message-eox
```

To sign a message:

```javascript
var bitcore = require('bitcore-lib-eox');
var Message = require('bitcore-message-eox');
